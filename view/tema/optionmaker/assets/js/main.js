...
$(document).ready(() => {
    ...
    if (window.location.href.indexOf('dados-invalidos') != -1) {
        alert_custom('CNPJ ou código inválido(s)!');
    }
    if (window.location.href.indexOf('codigo-usado') != -1) {
        alert_custom('Este código já foi usado!');
    }
